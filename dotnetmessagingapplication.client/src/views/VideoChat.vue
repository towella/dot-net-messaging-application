...
<template>
    <div id="settings">
        ...
        <Widget id="menu-body">
            ...
            <div class="menu-item">
                <label class="desc" for="mic-select">Choose camera: </label>
                <select id="camera-select" title="camera-select">
                    <option value="bluetooth">Webcam</option>
                    <option value="wired">External camera</option>
                </select>
            </div>
